...
public class SurveyNewFamilyReviewFrag extends AbstractSurveyFragment {
    ...
    {
        private WeakReference<SurveyNewFamilyReviewFrag> fragReference;

        SaveFamilyAsyncTask(SurveyNewFamilyReviewFrag frag)
        {
            fragReference = new WeakReference<SurveyNewFamilyReviewFrag>(frag);
        }
